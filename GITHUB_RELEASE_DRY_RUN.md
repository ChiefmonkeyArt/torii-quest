...
> generated: 2026-06-26T18:29:13.440Z
...
- ✓ Current version stamped (config.js VERSION) — _ok_: v0.2.232-alpha
- ✓ config VERSION matches package.json — _ok_: v0.2.232-alpha == v0.2.232-alpha
...
git tag -a v0.2.232-alpha -m "Torii Quest v0.2.232-alpha (MVP proof)"
# publish the tag — DO NOT run without user approval
git push origin v0.2.232-alpha
# create the GitHub release — DO NOT run without user approval
gh release create v0.2.232-alpha --notes-file RELEASE_NOTES_DRAFT.md --title "Torii Quest v0.2.232-alpha"
```
