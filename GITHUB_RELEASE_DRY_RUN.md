...
> generated: 2026-06-26T09:30:55.564Z

- **Verdict:** NEAR
- **Version:** v0.2.222-alpha @ 8fc41e8 (source)
- **package.json:** 0.2.222-alpha
- **Live:** https://torii-quest.pplx.app

## Prerequisites

- ✓ Current version stamped (config.js VERSION) — _ok_: v0.2.222-alpha
- ✓ config VERSION matches package.json — _ok_: v0.2.222-alpha == v0.2.222-alpha
...
git tag -a v0.2.222-alpha -m "Torii Quest v0.2.222-alpha (MVP proof)"
# publish the tag — DO NOT run without user approval
git push origin v0.2.222-alpha
# create the GitHub release — DO NOT run without user approval
gh release create v0.2.222-alpha --notes-file RELEASE_NOTES_DRAFT.md --title "Torii Quest v0.2.222-alpha"
```
