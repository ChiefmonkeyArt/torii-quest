# ADR-0093 — Sticker studio full sandboxing (SkinnedMesh raycast inside the napplet iframe)

**Status:** Deferred · **Date:** 2026-08-31
**Deciders:** chiefmonkey
**Related:** ADR-0057 (NappletSurface), ADR-0083 (avatar shell), ADR-0085 (sticker studio wiring-only), ADR-0088 (in-world raycast sticker placement), ADR-0094 (release-time napplet identity, planned), ADR-0092 (arena full sandboxing, proposed)
