...
- **Related:** [ADR-0103](0103-mixamo-colon-bone-names.md) (this ADR was originally drafted as 0103 in a parallel session; the 0103 slot was taken by the Mixamo bone-names fix so this work landed as 0104 with the body intact).
