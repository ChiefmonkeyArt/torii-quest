...
| [0103](./0103-beacon-relay-coverage-refresh.md) | Refresh `DEFAULT_NODE_RELAYS` to only relays that accept + round-trip `kind:30078`; commit `tools/relay-probe.mjs` for repeatability | Accepted |
