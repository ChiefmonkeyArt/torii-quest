...
Environment=QUEST_NODE_RELAYS=wss://relay.plebeian.market,wss://relay.routstr.com,wss://nos.lol,wss://relay.damus.io,wss://relay.primal.net,wss://relay.snort.social,wss://nostr.mom
