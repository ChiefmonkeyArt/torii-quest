...
export const VERSION   = 'v0.2.520-alpha';
...
export const TRAVEL_GATE_X  = 3;   // v0.2.519: at NAP zone edge
export const TRAVEL_GATE_Z  = 31;  // v0.2.519: flush with northern rim
...
export const TRAVEL_GATE_YAW_DELTA = -0.15; // v0.2.519: slight angle, flush with edge
