...
export const VERSION   = 'v0.2.801-alpha';
...
export const MP_ENABLED     = true; // MP-1.5: sandbox-hosted arena, live on chiefmonkey.art
...
// v0.2.801-alpha (UPD-2): admin identity for the server-side "Update Now" gate.
