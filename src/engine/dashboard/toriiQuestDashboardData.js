...
// These mirror the most recent committed LIVE_SMOKE_STATE.json (app-entry, v0.2.740-alpha PASS
// 3/3) and DASHBOARD_SMOKE_STATE.json (oversight dashboard, v0.2.740-alpha PASS 4/4). The smoke
...
// ----------------------------------------------------------------------------
// MP-3 (v0.2.740-alpha) — Leaderboard tile.
