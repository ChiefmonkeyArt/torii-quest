...
// (chiefmonkey.art) serves by EXACT static-asset path with NO SPA rewrite and NO
...
// and the root shell always renders — the only host-safe form on chiefmonkey.art.
...
// (chiefmonkey.art) has no SPA rewrite and no directory index and 404s every `/zone/*`
