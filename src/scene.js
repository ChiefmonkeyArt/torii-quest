...
// shell at radius 550 (inside camera.far=1000, in front of Sky.js box). Each
...
// v0.2.510: World-space at radius 560, facing arena center (0,0,0).
// CircleGeometry(270) — edges at sqrt(756²+270²)=803 < far=1000 from worst camera position.
// lookAt(0,0,0) faces the arena — no oval, no tilt, perfectly round from arena center.
const _sunSprite = new THREE.Mesh(
  new THREE.CircleGeometry(270, 64),
  _sunSpriteMat
);
_sunSprite.position.copy(_sunDir).multiplyScalar(560);
_sunSprite.lookAt(0, 0, 0);
