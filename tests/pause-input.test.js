...
describe('pause modal input boundary', () => {
  it('opens pause from Escape keydown or a browser-consumed pointer-lock Escape keyup', () => {
    ...
    // _openPause transitions out of PLAYING before pointer-lock release. Shots
    // additionally require pointer lock, so the click that re-acquires lock can
    // never fire a shot at the stale aim point.
