// tests/torii-quest-dashboard.model.test.js — split from torii-quest-dashboard.test.js (E3, v0.2.267).
// Slice: data model + JSON snapshot (buildToriiQuestModel, toriiQuestDataJSON).
...
describe('toriiQuestDataJSON', () => {
  it('is JSON-serialisable and carries totals + the seed contributors', () => {
    ...
    expect(round.version).toBe('v0.2.383-alpha');
