...
Current version: `v0.2.294-alpha`
Live site: [torii-quest.pplx.app](https://torii-quest.pplx.app)

## Source of truth (active task queues)

- `torii-quest-todo.md` — **Torii Quest** (game app) active task source of truth.
- `torii-continuum-todo.md` — **Torii Continuum** (oversight dashboard app) active task source of truth.
- `torii-quest-strategy.md` — shared strategy and decision rules.
- `torii-quest-progress.md` — Torii Quest progress dashboard.
- `torii-quest-handoff.md` / `CODE_INDEX.md` — contributor + agent onboarding and runtime index.
...
build (`tools/build-continuum.mjs`) treat `torii-quest-todo.md` as a continuity doc: it must
...
to `torii-quest-todo.md` / `torii-continuum-todo.md`; what remains is the historical
...
dashboard's completed-task count. Details are in `torii-quest-progress.md` and git history.
