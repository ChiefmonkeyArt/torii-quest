// tools/regression-check.mjs — static smoke/regression guardrails (v0.2.187).
...
const EXPECTED_VERSION = 'v0.2.187-alpha';
...
console.log(`[5] version markers == ${EXPECTED_VERSION}`);
{
  ...
  if (/v0\.2\.186-alpha/.test(html)) fail('index.html still references v0.2.186-alpha');
