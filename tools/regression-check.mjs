// tools/regression-check.mjs — static smoke/regression guardrails (v0.2.165).
...
const EXPECTED_VERSION = 'v0.2.165-alpha';
...
console.log(`[5] version markers == ${EXPECTED_VERSION}`);
{
  ...
  if (/v0\.2\.164-alpha/.test(html)) fail('index.html still references v0.2.164-alpha');
