...
export const RELEASE_PACKAGE_ENTRIES = Object.freeze([
  ...
  Object.freeze({ key: 'handoff', file: 'torii-quest-handoff.md', label: 'Handoff narrative (hand-maintained)', category: 'Release & handoff' }),
  ...
  Object.freeze({ key: 'progress', file: 'torii-quest-progress.md', label: 'Progress dashboard (source of truth)', category: 'Status & planning' }),
  Object.freeze({ key: 'todo', file: 'torii-quest-todo.md', label: 'Task list (source of truth)', category: 'Status & planning' }),
