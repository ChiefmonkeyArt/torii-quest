...
**Current version:** v0.2.541-alpha - CRATE PLAY ZONE GUARD (light-blue water planes). Prior: v0.2.540-alpha - REMOVED GROUND GLOW RIBBON. See §0 for the current snapshot.
...
- **Version:** v0.2.541-alpha (tag `v0.2.541-alpha`).
...
**PENDING DEPLOY:** v0.2.541-alpha is pushed to GitHub (tag `v0.2.541-alpha`) but NOT yet deployed to the VPS. The user needs to run:
```
sudo truncate -s 0 /var/log/torii-quest-update.log && sudo torii-deploy v0.2.541-alpha
```
