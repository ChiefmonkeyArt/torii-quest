...
**Current version:** v0.2.583-alpha - PER-BONE STICKER COLLIDERS ON BOTS. Prior: v0.2.574-alpha - PER-BONE NPC STICKER COLLIDERS. See §0 for the current snapshot.
...
- **Version:** v0.2.583-alpha (tag `v0.2.583-alpha`).
...
**PENDING DEPLOY:** v0.2.583-alpha is pushed to GitHub (tag `v0.2.583-alpha`) but NOT yet deployed to the VPS. The user needs to run:
```
sudo truncate -s 0 /var/log/torii-quest-update.log && sudo torii-deploy v0.2.583-alpha
```
