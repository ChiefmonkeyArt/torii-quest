...
**Current version:** v0.2.368-alpha (source at v0.2.368-alpha; LIVE at v0.2.366-alpha on https://chiefmonkey.art/quest/ — Torii Suite SHC VPS install; pplx.app backend sandbox still 503, kept as secondary. See §9 + “Deployment conventions” in torii-quest-todo.md)
