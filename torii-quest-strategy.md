...
Current live version: `v0.2.365-alpha` (clean source at `v0.2.365-alpha`, MP-1.5 sandbox-hosted arena live on quest-torii.pplx.app)  
Multiplayer status: **MP-1.5 landed at v0.2.365-alpha** — arena-ws bundled into the pplx.app published sandbox; no VPS required. MP-2 server-authoritative hits (v0.2.364-alpha) preserved. See `MP_1_5_SPEC.md` for sandbox wiring, `MP_2_SPEC.md` for authoritative hit design.  
