...
Current live version: `v0.2.761-alpha` (clean source at `v0.2.761-alpha`)  
Multiplayer status: **MP-1.5 landed at v0.2.365-alpha** — arena-ws bundled into the hosted sandbox; no VPS required. MP-2 server-authoritative hits (v0.2.364-alpha) preserved. See `MP_1_5_SPEC.md` for sandbox wiring, `MP_2_SPEC.md` for authoritative hit design.  
...
These are now live on `chiefmonkey.art`:
